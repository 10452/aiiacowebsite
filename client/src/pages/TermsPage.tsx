        ...
        <main className="flex-1" style={{ paddingTop: "100px", paddingBottom: "100px" }}>
          <div className="container" style={{ maxWidth: "720px" }}>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <h1 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', Arial, sans-serif", fontSize: "clamp(32px, 4vw, 52px)", fontWeight: 700, color: "rgba(255,255,255,0.97)", margin: "0 0 20px", letterSpacing: "-0.8px", lineHeight: 1.1 }}>
                Terms of Service
              </h1>
              <div className="gold-divider" style={{ marginBottom: "32px" }} />
              <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Helvetica Neue', Arial, sans-serif", fontSize: "15px", lineHeight: 1.75, color: "rgba(200,215,230,0.72)", display: "flex", flexDirection: "column", gap: "20px" }}>
                ...
                <h2 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', Arial, sans-serif", fontSize: "22px", fontWeight: 700, color: "rgba(255,255,255,0.90)", margin: "8px 0 4px" }}>Use of This Website</h2>
                ...
                <h2 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', Arial, sans-serif", fontSize: "22px", fontWeight: 700, color: "rgba(255,255,255,0.90)", margin: "8px 0 4px" }}>Intellectual Property</h2>
                ...
                <h2 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', Arial, sans-serif", fontSize: "22px", fontWeight: 700, color: "rgba(255,255,255,0.90)", margin: "8px 0 4px" }}>Engagement Terms</h2>
                ...
                <h2 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', Arial, sans-serif", fontSize: "22px", fontWeight: 700, color: "rgba(255,255,255,0.90)", margin: "8px 0 4px" }}>Limitation of Liability</h2>
                ...
                <h2 style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', Arial, sans-serif", fontSize: "22px", fontWeight: 700, color: "rgba(255,255,255,0.90)", margin: "8px 0 4px" }}>Contact</h2>
