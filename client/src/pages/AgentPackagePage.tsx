...
const ICON = {
  handshake: "https://d2xsxph8kpxj0f.cloudfront.net/310419663031409823/jiUKWZNCEesKEKgdJkoZwj/aiia-icon-handshake-aPpLfARcj64PcMhQFxNgTw.webp",
  ...
  skyline: "https://d2xsxph8kpxj0f.cloudfront.net/310419663031409823/jiUKWZNCEesKEKgdJkoZwj/aiia-icon-skyline-v1_b078c165.png",
};
